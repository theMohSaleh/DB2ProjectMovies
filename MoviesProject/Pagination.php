...
class Pagination {
    ...
    public function page($search, $sort) {
        ...
        if ($pageno > 1) {
            ...
            // 'first' and 'back' links
            $this->firstBack = "<div><a href='$_SERVER[PHP_SELF]?sort=$sort&submitted=1&search=$search&pageno=1&showRank=$srank&searchType=$sType'>First</a> <a href='$_SERVER[PHP_SELF]?sort=$sort&submitted=1&search=$search&pageno=$prevpage&showRank=$srank&searchType=$sType'>Back</a></div>";
        }
