...
<div class = "flex justify-content-between">
                ...
                <button class="btn btn-secondary" name="submitted" type="submit"><?php echo $lang['GO']; ?></button>
                <button class="btn btn-secondary" style="background-color:#999999" id="clear" type="button"><?php echo $lang['CLEAR']; ?></button>
            </form>
</div>
<?php 
    if (!empty($row)) {
